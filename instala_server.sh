...
wget https://raw.githubusercontent.com/barba99/admbarba/master/adm-server.tgz > /dev/null 2>&1
wget https://raw.githubusercontent.com/barba99/admbarba/master/bin.tgz > /dev/null 2>&1
...
wget -O trans https://raw.githubusercontent.com/barba99/admbarba/master/Instalar/trans -o /dev/null 2>&1

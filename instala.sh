...
valid_fun () {
echo -e "${cor[2]} Excelente!, llave Valida! Instalando..."
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
...
echo -e "${cor[3]} Ahora Seran Instalado las Dependencias"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
cd /etc/adm-lite
chmod +x ./*
instalar_fun
...
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[3]}Perfecto Procedimento Termino con Exito!"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[3]} |∆| ${cor[2]} єℓ r¢σησ¢ιмιєηтσ єѕ ℓιвяє"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[2]} Use Los Comandos:${cor[3]} menu, adm"
echo -e "${cor[2]} De Acceso al script, gracias!"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -ne " \033[0m"
}
verify_fun () {
...
unset serial
unset server
echo -ne "\033[1;33m SU LLAVE DE ACCESO!: \033[1;37m"; read serial
...
rm $HOME/tmp
    ...
    echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[0m"
    echo -ne "${cor[2]}Probar otra llave?? [S/N]: "; read other
...
error_fun () {
echo -e "${cor[5]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "\033[1;31mArquitetura No Soportada!"
echo -e "${cor[5]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -ne "\033[0m"
exit 1
}
...
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[2]} Utilize o Link de Instalacao Oficial:\n\033[1;36m (https://raw.githubusercontent.com/barba99/admbarba/master/instala.sh)${cor[2]}\n $(source trans -b pt:${id} "Nao utilize outros Links!")"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
echo -e "${cor[5]} ADM-ULTIMATE ${cor[3]} ву: נσяﻭє вαявα ®"
echo -e "${cor[1]}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"
